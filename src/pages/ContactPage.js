    ...
    return (
      <div className="main contact">
        ...
        <div className="contact__info">
          <span>
            <i className="contact__info-icon fas fa-user"></i>Bartek Mogielnicki
          </span>
          <span>
          ...
          <div className="contact__info-social">
            <a
              href="https://www.linkedin.com/in/bart%C5%82omiej-mogielnicki/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span>
                <i className="contact__info-social-link fab fa-linkedin-in"></i>
              </span>
            </a>
            <a
            ...
            >
              <span>
                <i className="contact__info-social-link fab fa-github"></i>
              </span>
            </a>
          </div>
        </div>
